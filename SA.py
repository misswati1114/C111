...
first_std_deviation_start, first_std_deviation_end = mean_sd-std_deviation_sd, mean_sd+std_deviation_sd
second_std_deviation_start, second_std_deviation_end = mean_sd-(2*std_deviation_sd), mean_sd+(2*std_deviation_sd)
third_std_deviation_start, third_std_deviation_end = mean_sd-(3*std_deviation_sd), mean_sd+(3*std_deviation_sd)
...
fig = ff.create_distplot([mean_list], ["student marks"], show_hist=False)
fig.add_trace(go.Scatter(x=[mean_sd, mean_sd], y=[0, 0.17], mode="lines", name="MEAN"))
